...
// import { TargetResolverContext } from "../target-resolvers.js";
...
//         source.quads = generateTriplesForInput(source.subject, input, utils.unwrapNonNull(inputType) as GraphQLInputObjectType, namedNode(className));
